...
class RuntimeSettings:
    ...
    scrape_dispatch_batch_size: int = 5
    ...
    scraper_content_wait_poll_seconds: float = 0.25
    scraper_challenge_second_cycle_enabled: bool = True
    scraper_challenge_second_cycle_pre_reload_delay_seconds: float = 1.0
    scraper_challenge_second_cycle_post_reload_delay_seconds: float = 1.0
    ...
    cf_bypass_delay_min_s: float = 0.1
    cf_bypass_delay_max_s: float = 1.5
    cf_bypass_delay_long_pause_probability: float = 0.0
    cf_bypass_delay_long_pause_max_s: float = 12.0
    cf_bypass_inter_request_base_s: float = 0.2
    cf_bypass_inter_request_variance: float = 0.1
