...
def test_niche_subscriber_matching_requires_both_conditions() -> None:
    ...
    channels = [
        seed_channel,
        {"id": "a", "niche_tags": ["gold"], "subscriber_count": 1050},
        {"id": "b", "niche_tags": ["gold"], "subscriber_count": 1200},
        {"id": "c", "niche_tags": ["culture"], "subscriber_count": 1000},
    ]
    ...
    assert "Shared tags: gold" in str(matches[0]["match_detail"])
